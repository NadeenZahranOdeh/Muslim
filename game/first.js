...
function endGame(){
    ...
    if(percentage >= 50){
        ...
        localStorage.setItem("level3Passed", "false");
    }

    localStorage.setItem("level3Score", score);
    questionEl.textContent = lives === 0 ? "Game Over!" : "Congratulations!";
    answersEl.innerHTML = "";
    feedbackEl.textContent = `Final Score: ${score} (${Math.round(percentage)}%)`;
...
restartBtn.onclick = function(){
    ...
    localStorage.removeItem("level3Passed"); 
