...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // التأكد من وجود العناصر في الصفحة أولاً لتجنب الأخطاء
    if (publicToggle && toggleLabel) {
        
        // دالة لتحديث النص بناءً على حالة الزر
        ...
        // تشغيل الدالة فوراً عند تحميل الصفحة لضبط النص الأولي
        updateToggleLabel();

        // الاستماع لحدث التغيير عند الضغط على الزر
